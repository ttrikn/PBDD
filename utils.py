...
# t2_coarse = {
#     'content': ['[CLS] Sentiment of the sentence "I feel bad !" is negative . Sentiment of the sentence "I feel good '
#                 '!" is positive . Text : " ', ' " . Sentiment of text : [MASK] . [SEP]'],
#     'map': [0, 's', 1],
#
#     # default multi-modal template
#     'default': {
#         'content': ['[CLS]', '[SEP] Sentiment of the sentence "I feel bad !" is negative . Sentiment of the sentence '
#                              '"I feel good !" is positive . Text : " ', ' " . Sentiment of text : [MASK] . [SEP]'],
#         'map': [0, 'i', 1, 's', 2],
#     },
# }
...
# t2_coarse = {
#     #depression数据集专用
#     'content': ['[CLS] Sentiment of the sentence "I want to die !" is depressed . Sentiment of the sentence "I feel happy '
#                 '!" is positive . Text : " ', ' " . Sentiment of text : [MASK] . [SEP]'],
#     'map': [0, 's', 1],
#
#     # default multi-modal template
#     'default': {
#         'content': ['[CLS]', '[SEP] Sentiment of the sentence "I want to die !" is depressed . Sentiment of the sentence '
#                              '"I feel happy !" is positive . Text : " ', ' " . Sentiment of text : [MASK] . [SEP]'],
#         'map': [0, 'i', 1, 's', 2],
#     },
# }
...
def twitterdp(template: int):
    label_list = ['depressed', 'neutral', 'positive']
    label_map = {'depressed': "depressed", 'neutral': "neutral", 'positive': "positive"}
    return label_list, label_map, template_coarse[template]
