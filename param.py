...
parser.add_argument("--img_dir", type=str, default='./datasets/TWITTER')
parser.add_argument("--out_dir", type=str, default='./output')

# dataset settings
parser.add_argument("--dataset", type=str, default='twitterdp')
parser.add_argument("--train_file", type=str, default='train_few4.tsv')
parser.add_argument("--dev_file", type=str, default='dev_few4.tsv')
...
# template settings
parser.add_argument("--template", type=int, default=2)
parser.add_argument("--prompt_token", type=str, default='[unused1]')
parser.add_argument("--prompt_shape", type=str, default='111')
parser.add_argument("--lstm_dropout", type=float, default=0.0)
parser.add_argument("--img_token", type=str, default='[unused2]')
parser.add_argument("--pooling_scale", type=str, default='11')
...
parser.add_argument("--lr_lm_model", type=float, default=1e-5)
parser.add_argument("--lr_resnet", type=float, default=0)
parser.add_argument("--lr_visual_mlp", type=float, default=1e-5)
...
parser.add_argument("--up_model_path", type=str, default='./up-models/rot_pretrain_49-1-94.36.bin')
