...
class MSAModel(torch.nn.Module):
    ...
    def __init__(self, args, label_id_list):
        ...
        if not args.no_img:
            ...
            #print(args.img_token_len)#1
            # print(self.embedding_dim)#768
    ...
    def embed_input(self, input_ids, imgs=None):
        ...
        if not self.args.no_img:
            ...
            #visual_embeds = self.model(imgs, '', mode='image')[:, 0].unsqueeze(1)
            #print(input_ids)
            #print(visual_embeds.shape) #[34, 1, 768]
...
#         print(input_ids.shape)#([34, 84])
#         print(inputs_embeds.shape)#([34, 84, 768])
